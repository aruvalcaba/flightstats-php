 ...
 */
class FlightTracksByDepartingDateTest extends QueryTest
{
    function setUp()
    {
        parent::setUp();
        
        $this->query = new FlightTracksByDepartingDate($this->client);
    }
     ...
     * @dataProvider dataProvider 
     */
    function testFlightTracksByTooOldDepartingDate(string $carrier, string $flight, string $date)
    {
        $date = $this->carbon->createFromFormat('Y-m-d', $date);
